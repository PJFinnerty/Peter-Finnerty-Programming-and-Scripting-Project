...
plt.suptitle("Setosa: Univarariate Analysis of CDF and PDF")
sns.set_style("darkgrid")
...
# are also used in the univariate analysis of the Iris dataset, as provided in 'Summary.md' file (Q3,i).
...
# Graphs are supplentary and required for bivariate analysis of the dataset.

# (i) VIRGINICA CONTOUR PLOTS
# Use Seaborn's 'Jointplot' to create a 2D density contour plot of Virginica.
...
with open('summary.md','w') as out: # ref: https://stackoverflow.com/questions/17394846/print-the-output-in-txt-from-command-line-using-python
    ...
    README.md file.\n")
    print("This section provides some structural details on the dataset, however the majority of this\
    file contains the results of univariate and  bivariate analysis of the dataset, based on\
    Matplotlib graphs created in 'Analysis.py.'\n\n")
    print("**Section 2 below presents the results of univariate analysis of histograms and Cumulative\
    Density Functions of the Iris species.**\n\n")
    print("**Section 3 relates to bivariate analysis of scatter plots and contour plots.**\n\n\n")
    
    print("### 1.1. Dataset Structure\n\n")

    print("Below are details relating to the structure of the Iris Dataset, providing summaries\
    of the 4 features.\n\n")

    print("**No. of rows/no. of columns:** ", df.shape, "\n\n")

    print("**Names of species/no. of vectors:**\n")
    print("Iris Virginica:     50\n")
    print("Iris Setosa:       50\n")
    print("Iris Versicolor: 50\n\n") 

    print("**Column headers:** Sepal Length | Sepal Width | Petal Length | Petal Width | Species |\n\n\n")
    ...
    print("|Mean |   5.843333 |   3.054000 |    3.758667 |   1.198667 |")
    print("|Standard Deviation |   0.828066 |   0.433594 |    1.764420 |   0.763161 |")
    print("|Minimum Datapoint |   4.300000 |   2.000000 |    1.000000 |   0.100000 |")
    print("|25th Percentile |   5.100000 |   2.800000 |    1.600000 |   0.300000 |")
    print("|50th Percentile |   5.800000 |   3.000000 |    4.350000 |   1.300000 |")
    print("|75th Percentile  |   6.400000 |   3.300000 |    5.100000 |   1.800000 |")
    print("|Maximum Datapoint |   7.900000 |   4.400000 |    6.900000 |   2.500000 |")
    ...
    print("The histogram of Petal Length displays some minor overlap in ths Virginica and Versicolor species. Measurements for\
    Versicolour begin roughly at 3.2cm and end at 5.3cm. Whilst Versicolour shows a histogram curve rangin from 4.2cm to 7cm. The overlap occurs between 4cm \
    and 5.1cm. Looking at the CDF function of Virginica (which begins at roughly 4.4cm, it is noticed that less than 25 percent of Virginica PL vectors are less\
    than 5.1cm. Whilst this is a small overlap it is clear that a histogram univariate analysis of Petal Length does not adequately distinguish between Versicolor\
    and Virginica.\n")
    ...
    print("Once again there is a slight overlap in Petal Width of the\
    ...
    print("### Versicolor")
    print("The histogram for Versicolor SL has massive overlap with Setosa in the range \
    ...
    at SL.\n")
    print("### Virginica")
    print("As has already been noted, the overlap of Virginica with Versicolor in the \
    ...
    print("**Setosa result:** moderate overlap with Versicolor\n")
    ...
    print("### Virginica")
    print("The histogram of Virginica SW is immediately recognised as being useless in \
    ...
    print("### Setosa")
    print("The histogram of Setosa SW shows bars ranging from 2.5cm-4.25cm, with the peak \
    ...
    print("## 3.2. Distinguishing Virginica from Veriscolor by Linear Regression")
    print("Versicolor and Virginica, species that were shown to display little\
    ...
    print("**x = [4.2, 5.65]**\n")
    print("**y = [2.0, 1.0]**\n\n")
    print("The above corrdinates are shown to draw a diagonal across the scatter plot that leaves only\
    ...
    print("**x = [4.5, 7.5]**\n")
    print("**y = [4.6, 5.0]**\n\n")
    print("The diagonal that is drawn with the above coordinates, casts a line that generally\
    ...
    print("**x = [1.8, 3.6]**\n")
    print("**y = [4.1, 5.2]**\n\n")
    print("Linear separation here results in 2 Viginica outliers on the Versicolor side of the line and\
    ...
    print("**x = [4.0, 8.0]**\n")
    print("**y = [1.60, 1.60]**\n\n")
    print("This line of separation results in 4 outlier Virginica vectors on the Versicolor side of the\
    ...
    print("**x = [2.0, 3.80]**\n")
    print("**y = [1.55, 1.70]**\n\n")
    print("This line of regression results in 4 Virginica outliers on the Versicolor side of the line and\
